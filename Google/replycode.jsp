...
<body>
    <form action="composedata.jsp" style="height:580px;width:1100px;background-color: #fff;">
        <div id="message">
        ...
        <div>
            <textarea id="textarea" style="height:350px;"name="content" placeholder="Compose your Email"><%=rs1.getString("content")%></textarea>
        </div>
        <%
                                }
                            }
