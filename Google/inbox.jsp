	...
	<form action="deletedata.jsp">
		...
		<div class="contain col-lg-10 col-md-8">
			...
			<div>
				...
				<table>
					<% Date d=new Date(); 
					ps1=con.prepareStatement("Select * from compose");
					...
					{ 
						if(email.equals(rs1.getString("recipients"))) { %>
							<tbody>
								<tr>									
									<td class="col-lg-3">
										<a href="message.jsp?id=<%= rs1.getString("id") %>" style="text-decoration: none;color: black;"><input type="checkbox" name="cb1" value='<%= rs1.getString("id") %>' class="select" style="width:60px;height:15px;"> <%=rs1.getString("from1")%></a>
									</td>
									<td class="col-lg-3">
										<a href="message.jsp" style="text-decoration: none;color: black;"><%=rs1.getString("subject")%></a>
									</td>
									<td class="col-lg-6">
										<a href="message.jsp" style="text-decoration: none;color: black;"><%=rs1.getString("content")%></a>
									</td>
								</tr>
							</tbody>
