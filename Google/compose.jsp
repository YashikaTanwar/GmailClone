...
<body>
    <form action="composedata.jsp" style="height:500px;background-color: #fff;">
        <div id="message">
        ...
        <div>
            <input type="email" placeholder="Recipients" id="recipients" name="recipients" style="width:100%">
        </div>
        <div>
            <input type="text" placeholder="Subject" id="subject" name="subject">
        </div>
        <div>
            <textarea id="textarea" name="content" placeholder="Compose your Email"></textarea>
        </div>
        <div class="bottom">
